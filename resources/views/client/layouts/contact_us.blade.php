            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        ...
                        <ul>
                            <li>
                                <p><i class="fas fa-map-marker-alt"></i>{{trans('message.Address')}}: Số 1A Tân Thái <br>Mân Thái District<br> Sơn Trà Ward</p>
                            </li>
                            <li>
                                <p><i class="fas fa-phone-square"></i>{{trans('message.Phone')}}: <a href="">+(84) 0355032314</a></p>
                            </li>
                            <li>
                                <p><i class="fas fa-envelope"></i>{{trans('message.Email')}}: <a href="mailto:Tamhcgcd17190@fpt.edu.vn">Tamhcgcd17190@fpt.edu.vn</a></p>
                            </li>
                        </ul>
                    </div>
                </div>
